    ...
    const ownerBar = (
        <>
            <OwnerBar
                ...
                // Dupliquer et signaler exigent un compte (ROLE_USER côté API) : la fiche
                // est désormais lisible sans compte (jalon B), donc un visiteur anonyme ne
                // doit pas voir un bouton qui échouerait systématiquement.
