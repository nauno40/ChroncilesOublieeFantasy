...
- `Campaign` ↔ `Character` : supprimer une campagne avec des personnages rattachés est refusé (409) — comportement à traiter côté produit avant d'offrir « supprimer ma campagne » à des inconnus.
