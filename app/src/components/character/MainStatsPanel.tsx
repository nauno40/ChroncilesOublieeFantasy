    ...
    return (
        <div className="grid grid-cols-2 gap-3">
            <div className="glass-panel p-3 rounded-xl text-center border-stone-800 relative overflow-hidden bg-stone-900/10">
                <label className="text-[11px] uppercase font-black text-stone-400 tracking-[0.2em] block mb-1">Initiative</label>
                <div className="text-2xl font-display font-bold text-stone-300 drop-shadow-[0_0_10px_rgba(255,255,255,0.1)]">
                    {combatStats.init}
                </div>
                <div className="text-[11px] text-stone-400 font-bold uppercase mt-1">10 + PER + Bonus</div>
            </div>
            <div className="glass-panel p-3 rounded-xl text-center border-primary-500/20 relative overflow-hidden group bg-stone-900/10">
                ...
                <div className="text-[11px] text-stone-400 font-bold uppercase mt-1">10 + AGI + Armure</div>
            </div>
            <div className="glass-panel p-3 rounded-xl text-center border-green-900/40 bg-green-950/5 relative overflow-hidden transition-all hover:bg-green-950/10 col-span-2">
                ...
                <div className="flex items-center justify-center gap-1.5">
                    ...
                    <span className="text-lg font-display font-bold text-stone-400">{maxHp}</span>
            ...
            >
                ...
                <div className="flex items-center justify-center gap-2">
                    ...
                    <span className="w-8 text-center text-sm text-stone-400 font-bold">{luckMax}</span>
                </div>
            ...
            <div className="glass-panel p-3 rounded-xl border-white/5 bg-stone-900/20 col-span-2 flex items-center justify-around px-6">
                <div className="flex flex-col items-center">
                    ...
                    <div className="text-[11px] text-stone-400 text-center font-bold uppercase mt-1">Dé de récup.</div>
                </div>
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="text-[11px] text-stone-400 text-center font-bold uppercase mt-1">Dé évolutif d4°</div>
                </div>
            </div>
            ...
            <div className="glass-panel p-3 rounded-xl col-span-2 border-white/5 bg-stone-900/20">
                <div className="grid grid-cols-2 gap-4 h-full divide-x divide-white/5">
                    <div className="text-center">
                        <label className="text-[11px] uppercase font-black text-stone-400 tracking-widest block mb-1">Atk. CàC</label>
                        <div className="text-xl font-display font-bold text-white text-shadow-sm transition-all hover:scale-110">
                            <span className="text-stone-400 text-xs mr-1">+</span>{attackValue(mods[contactCarac], character.level || 1) + attackBonus}
                        </div>
                    </div>
                    <div className="text-center pl-4">
                        <label className="text-[11px] uppercase font-black text-stone-400 tracking-widest block mb-1">Atk. Tir</label>
                        <div className="text-xl font-display font-bold text-white text-shadow-sm transition-all hover:scale-110">
                            <span className="text-stone-400 text-xs mr-1">+</span>{attackValue(mods[distanceCarac], character.level || 1) + attackBonus}
                        </div>
                    </div>
                </div>
                {dmBonus > 0 && (
